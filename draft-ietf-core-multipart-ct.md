...
CoAP request or response body with minimal framing overhead, each along with a CoAP
...
into a single CoAP {{-coap}} request or response body with minimal framing
